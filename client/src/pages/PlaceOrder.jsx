...
const PlaceOrder = () => {
  ...
  const OnSubmitHandler = async (event) => {
    ...
    if (!city.trim() || !nameRegex.test(city)) {
      toast.error("Please enter a valid city (letters only).");
      return;
    }
    if (!state.trim() || !nameRegex.test(state)) {
      toast.error("Please enter a valid state (letters only).");
      return;
    }
    ...
    if (!country.trim() || !nameRegex.test(country)) {
      toast.error("Please enter a valid country (letters only).");
      return;
    }
